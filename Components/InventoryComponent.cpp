...
void UInventoryComponent::SplitExistngStack(UItemBase* ItemIn, const int32 AmountToSplit)
{
...
FText::FromString("Successfully added single {0} to the inventory."),InputItem->ItemTextData.Name));
}
