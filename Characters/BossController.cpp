...
void ABossController::BeginPlay()
{
	...
	// 바인딩
	Perception->OnPerceptionUpdated.AddDynamic(this, &ABossController::OnPerceptionUpdated);
}
...
void  ABossController::OnPossess(APawn* InPawn)
{
	...
	Enemy = Cast<ACEnemy_Boss>(InPawn);        // BP
...
void  ABossController::OnPerceptionUpdated(const TArray<AActor*>& UpdatedActors)
{
